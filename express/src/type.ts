...
// TypeScript types
export type PaymentSwapQuoteIntent = z.infer<
  typeof PaymentSwapQuoteIntentSchema
>;
export type PaymentSwapQuoteAttestation = z.infer<
  typeof PaymentSwapQuoteAttestationSchema
>;
