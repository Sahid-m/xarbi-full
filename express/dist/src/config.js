...
export const LoadedCA = {
    usdc: "0xf71E017904d653fb6640BA100973d65c9C54988D",
    weth: "0xA8528aBB7546A780C8AAf8Db8F4A909ea3F3b84D",
    quoteRegistry: "0x07E7767F524B0ae75328405D74cB598354eeD287",
    mockAdapter: "0x819d378650F3aE6BB6cAC74f22E2140a87EDB7b5",
    executor: "0x60515165D1663b2EE618CcDC553Eae7f04d9f5A4",
    quoteServiceSigner: "0x86C478bdEAfa70c647A72c895e706b7D8757C72d",
};
...
export async function verifyMerchant(req, res, next) {
...
export function build402Response(resource, error, addresses, merchantAddress) {
    return {
        x402Version: 1,
        error,
        accepts: [
...
export async function getMerchantKeys(merchantID) {
    ...
    return {
        privateKey: Project?.user.wallet?.privateKey,
        publicKey: Project?.user.wallet?.publicKey,
    };
}
